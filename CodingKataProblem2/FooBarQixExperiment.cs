...
{
    public class FooBarQixExperiment
    {
        ...
        public FooBarQixExperiment(int number)
        {
            this._number = number;
        ...
        public FooBarQixExperiment ToCustomUpper()
        {
        ...
        public FooBarQixExperiment GetFooBarQixResult()
        {
            Result = GetResultIfEmpty(FooBarQixResult());
            //return _result;
            return this;
        }
